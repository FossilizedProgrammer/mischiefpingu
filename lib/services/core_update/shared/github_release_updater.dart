...
//
// ═══════════════════════════════════════════════════════════════
//  GithubReleaseUpdater — Facade برای check + update
//  منطق واقعی در:
//    • github_core_spec.dart          → GithubCoreSpec
//    • github_release_checker.dart    → check
//    • github_release_installer.dart  → update
// ═══════════════════════════════════════════════════════════════
library;
...
// Re-export برای سازگاری کامل با import های قدیمی.
