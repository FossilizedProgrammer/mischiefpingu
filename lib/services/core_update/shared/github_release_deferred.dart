// lib/services/core_update/shared/github_release_deferred.dart
//
// ═══════════════════════════════════════════════════════════════
//  GithubReleaseDeferred — منطق defer و verify برای GitHub Releases
//  (تفکیک شده از github_release_installer.dart)
//
//  مسئولیت‌ها:
//   • ذخیرهٔ باینری در staging و ثبت PendingCoreUpdate
//   • verify نصب (وجود فایل + اندازه)
// ═══════════════════════════════════════════════════════════════
library;
