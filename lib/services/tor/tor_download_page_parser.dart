...
class TorDownloadPageParser {
  ...
  TorDownloadPageParser({required this.log, required this.getText});
  ...
  Future<String?> discover(String? proxy, bool isWin, String archTag) async {
    try {
      log(
        '→ Fetching official download page: '
