// lib/services/aether/aether_failure_handler.dart
//
// ═══════════════════════════════════════════════════════════════
//  AetherFailureHandler — منطق تصمیم‌گیری پس از شکست یک attempt
//  (تفکیک شده از aether_test_executor.dart)
//
//  ⚠️ این کلاس stateless است؛ state (مثل _portSwapTried) توسط
//  AetherTestExecutor مدیریت می‌شود.
// ═══════════════════════════════════════════════════════════════
library;
