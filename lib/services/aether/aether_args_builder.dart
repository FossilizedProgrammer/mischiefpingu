// lib/services/aether/aether_args_builder.dart
//
// ═══════════════════════════════════════════════════════════════
//  AetherArgsBuilder — ساخت args خط فرمان Aether
//
//  ⚠️ pre-1.5 باینریها: --mim را نمی‌شناسند. اگر باینری قدیمی
//     باشد، attempt با mim به startFailed تبدیل می‌شود و planner
//     سراغ candidate بعدی می‌رود.
//
//  ⚠️ قواعد:
//   • --mim: nested MASQUE. با --h2 → HTTP/2 in HTTP/2.
//   • --fragment: فقط masque/mim + HTTP-2.
//   • noize: off | light | firewall | balanced | gfw | aggressive
//   • endpoint: برای gool → --wiw-outer، برای mim → --mim-outer،
//     برای masque/wg → --peer.
// ═══════════════════════════════════════════════════════════════
library;
...
class AetherArgsBuilder {
  ...
  List<String> build({
    ...
    // ─── H2 و fragment فقط برای masque/mim ───
